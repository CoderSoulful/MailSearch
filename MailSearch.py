...
des_space = "⁣  ⁣⁣  ⁣⁣ "
lines = space + "—"*85
validator_url = str(requests.get("https://github.com/CoderSoulful/MailSearch/blob/main/check.validator").text)
...
░  ░  ░  ░ ░ ░ ▒   ░░░ ░ ░   ░ ░    ░ ░    ░░░ ░ ░   ░ ░   
 ...
 | |\/| |/ _` | | |  \___ \ / _ \/ _` | '__/ __| '_ \ 
 | |  | | (_| | | |  ____) |  __/ (_| | | | (__| | | |
 |_|  |_|\__,_|_|_| |_____/ \___|\__,_|_|  \___|_| |_|
                                                      
                                                      ''')
    print(f'                  {w}.:.:;..{y} MailSearch Developer: Soulful {w}..;:.:.')
...
def selecttype():
    ...
    print(f"{space}{b}[{w}5{b}]{w} Update \n")
